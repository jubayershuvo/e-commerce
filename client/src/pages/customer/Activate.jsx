    ...
    const handleChange = (e) => {
      ...
      const handleSubmit = async (e) => {
        ...
        if(!code){
          ...
          const activateLoading = toast.loading('Saving information..!')
        try {
          // Send POST request to API endpoint
         await axios.post('/user/activate-user', {code},{
          withCredentials:true
         });
         
          toast.success('User activated successfully..!',{id:activateLoading});
          navigate('/login')
